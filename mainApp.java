...
public class mainApp {
	...
	public static void main(String[] args) {
		...
		// calling the personalData constructor to create an object from the given details
		...
		do {
			...
			// here I listed some common diseases associated with the elderly people along with their proper prescription
			switch (x) {
			case 1: {
				System.out.println();				
				...
				do {
					...
					case 2: {
						System.out.println("(2) Thyroid: Maintain regular thyroid function tests and work closely with your healthcare provider to manage thyroid conditions effectively.");
						c = 6;
						break;
					}
					case 3: {
					...
					case 4: {
						System.out.println("(4) Diabetes: Manage diabetes through a balanced diet, regular exercise, medication adherence, and routine monitoring of blood sugar levels under the guidance of your healthcare provider.");
						c = 6;
						break;
					}
					case 5: {
						System.out.println("(5) Osteoarthritis: Do exericse, manage your weight, apply pain relief strategies and medical guidance to enhance joint function and minimize discomfort.");
						c = 6;
						break;
					}
					case 6: {
						...
						System.out.println("Take proper diet and walk for atleast 30 mins. twice a day, also consult your doctor timely.");
						c = 6;
						break;
					}
		...
		System.out.println();
		System.out.println("\"To ensure GOOD HEALTH: Eat lightly, breathe deeply, live moderately, mild exercise daily and maintain an interest in life.\" \n");
